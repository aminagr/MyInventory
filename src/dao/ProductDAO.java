...
public class ProductDAO {
    ...
    public void addProduct(Product product) {
        String insertProductQuery = "INSERT INTO produits (nom, qt, prix, prixv, categorie, fournisseur, code) " +
                                    "VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection connection = databaseHandler.getConnection();
            ...
            insertProductStatement.setDouble(4, product.getPricev());
            insertProductStatement.setInt(5, product.getCategoryId());
            insertProductStatement.setInt(6, product.getProviderId());
            insertProductStatement.setString(7, product.getCodeBar());
    ...
    public List<Product> getAllProducts() {
        ...
        String selectQuery = "SELECT produits.id, produits.nom, produits.qt, produits.prix, produits.prixv, produits.code, " +
        ...
        try (Connection connection = databaseHandler.getConnection();
            ...
            while (resultSet.next()) {
                ...
                double pricev = resultSet.getDouble("prixv");
                ...
                Product product = new Product(productId, productName, quantity, price, pricev, codeBar, categoryName, fournisseurName, imagePaths);
    ...
    public void updateProduct(Product product, boolean deleteOldImages) {
        String updateProductQuery = "UPDATE produits SET nom = ?, qt = ?, prix = ?, prixv = ?, categorie = ?, " +
        ...
        try (Connection connection = databaseHandler.getConnection();
            ...
            updateProductStatement.setDouble(4, product.getPricev());
            updateProductStatement.setInt(5, product.getCategoryId());
            updateProductStatement.setInt(6, product.getProviderId());
            updateProductStatement.setString(7, product.getCodeBar());
            updateProductStatement.setInt(8, product.getId());
        ...
        try (Connection connection = databaseHandler.getConnection();
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    product = new Product(id, name, quantity, price, pricev, codeBar, categoryName, providerName, images);
                }
            }
